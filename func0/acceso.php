...
layout_header('Acceso', 'acceso.php');
?>
<main>
  <div class="panel">
      ...
      <form action="acceso.php#login" method="post" novalidate>
        ...
        <div class="form-grid">
          <div class="full">
            ...
            <?php if (isset($loginErrors['login'])): ?><div class="notice error"><?= e($loginErrors['login']) ?></div><?php endif; ?>
          </div>

          <div class="full">
            <label for="login-password">Contraseña</label>
            <input id="login-password" type="password" name="password">
            <?php if (isset($loginErrors['password'])): ?><div class="notice error"><?= e($loginErrors['password']) ?></div><?php endif; ?>
          </div>
        </div>
      ...
      <form action="acceso.php#registro" method="post" enctype="multipart/form-data" novalidate>
        ...
        <div class="form-grid">
          <div>
            ...
            <?php if (isset($registerErrors['username'])): ?><div class="notice error"><?= e($registerErrors['username']) ?></div><?php endif; ?>
          </div>

          <div>
            <label for="reg-email">Email</label>
            <input id="reg-email" type="email" name="email" value="<?= e($registerInput['email']) ?>">
            <?php if (isset($registerErrors['email'])): ?><div class="notice error"><?= e($registerErrors['email']) ?></div><?php endif; ?>
          </div>

          <div>
            <label for="reg-nombre">Nombre</label>
            <input id="reg-nombre" type="text" name="nombre" value="<?= e($registerInput['nombre']) ?>">
            <?php if (isset($registerErrors['nombre'])): ?><div class="notice error"><?= e($registerErrors['nombre']) ?></div><?php endif; ?>
          </div>

          <div>
            <label for="reg-apellidos">Apellidos</label>
            <input id="reg-apellidos" type="text" name="apellidos" value="<?= e($registerInput['apellidos']) ?>">
            <?php if (isset($registerErrors['apellidos'])): ?><div class="notice error"><?= e($registerErrors['apellidos']) ?></div><?php endif; ?>
          </div>

          <div>
            <label for="reg-password">Contraseña</label>
            <input id="reg-password" type="password" name="password">
            <?php if (isset($registerErrors['password'])): ?><div class="notice error"><?= e($registerErrors['password']) ?></div><?php endif; ?>
          </div>

          <div>
            <label for="reg-password-confirm">Repetir contraseña</label>
            <input id="reg-password-confirm" type="password" name="password_confirm">
            <?php if (isset($registerErrors['password_confirm'])): ?><div class="notice error"><?= e($registerErrors['password_confirm']) ?></div><?php endif; ?>
          </div>

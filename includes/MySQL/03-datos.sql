...
('Spaghetti Carbonara','Pasta con salsa carbonara y panceta',1,9.75,10,1,0, NULL),
('Ensalada César','Lechuga, pollo, crutones y salsa César',2,7.00,10,1,1, NULL),
('Hamburguesa Gourmet','Hamburguesa de ternera con queso cheddar y bacon',1,11.50,10,1,0, NULL),
('Sopa de Tomate','Sopa casera de tomate y albahaca',2,5.00,10,1,0, NULL),
...
('Pizza Pepperoni','Pizza con pepperoni y extra queso',1,9.50,10,1,1, NULL),
('Lasagna Boloñesa','Lasaña de carne con bechamel',1,10.00,10,1,0, NULL),
('Ensalada Caprese','Tomate, mozzarella y albahaca fresca',2,6.50,10,1,0, NULL),
...
('Pizza Hawaiana','Pizza con jamón y piña',1,9.00,10,1,0, NULL),
('Ravioli Ricotta','Raviolis rellenos de ricotta y espinaca',1,9.75,10,1,0, NULL),
...
('Pollo al Horno','Pollo asado con hierbas',1,12.00,10,1,0, NULL),
('Bistec de Ternera','Filete de ternera a la plancha',1,15.50,10,1,0, NULL),
...
('Pizza Vegetariana','Pizza con verduras asadas',1,9.25,10,1,1, NULL),
...
('Tagliatelle Boloñesa','Pasta fresca con salsa boloñesa',1,9.75,10,1,0, NULL),

            ...
            <?php if ($accion === 'preparar_barra'): ?>
                <div class="pedido-card-body">
                    ...
                    <?php if (empty($productos_barra)): ?>
                        ...
                        <?php $formListo = new \es\ucm\fdi\aw\Formulario\FormularioEstadoCamarero($pedido_id, 'pasar_entrega'); ?>
                        <?= $formListo->gestiona() ?>
                    <?php else: ?>
                        <ul>
                            <?php foreach ($productos_barra as $pb): ?>
                                <li>
                                    ...
                                    <?php else: ?>
                                        <?php $formLinea = new \es\ucm\fdi\aw\Formulario\FormularioEstadoCamarero($pedido_id, 'preparar_linea', (int)$pb->getProductoId()); ?>
                                        <?= $formLinea->gestiona() ?>
                                    <?php endif; ?>
                                </li>
                            <?php endforeach; ?>
